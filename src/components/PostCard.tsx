...
const PostCard = ({
  ...
  return (
    ...
    >
      <div className="relative h-full bg-white/80 rounded-2xl overflow-hidden border border-cyan-100 shadow-lg hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:-translate-y-2 flex flex-col">
        {/* Gradient Border Effect */}
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 via-blue-500 to-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
        ...
        <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden bg-gradient-to-br from-cyan-50 to-blue-50">
          ...
          {/* Floating Date Badge */}
          <div className="absolute top-4 left-4 bg-white/90 rounded-xl px-3 py-2 shadow-lg border border-cyan-100">
        ...
        {/* Content Container */}
        <div className="relative flex-grow p-5 sm:p-6 flex flex-col bg-white/95">
          {/* Decorative Line */}
